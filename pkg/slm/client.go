...
- For deployment failures: consider rollback_deployment
- For storage space issues: consider expand_pvc
- For security threats: consider quarantine_pod
- For node maintenance: consider drain_node
- For complex issues: consider collect_diagnostics first
