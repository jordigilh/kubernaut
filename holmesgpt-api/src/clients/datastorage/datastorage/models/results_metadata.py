...
class ResultsMetadata(BaseModel):
    ...
    """ # noqa: E501
    total_found: StrictInt = Field(description="Total number of workflows matching the query")
    returned: StrictInt = Field(description="Number of workflows returned in this response")
    workflows: List[WorkflowResultAudit]
    __properties: ClassVar[List[str]] = ["total_found", "returned", "workflows"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "total_found": obj.get("total_found"),
            "returned": obj.get("returned"),
            "workflows": [WorkflowResultAudit.from_dict(_item) for _item in obj.get("workflows")] if obj.get("workflows") is not None else None
        })
        return _obj
