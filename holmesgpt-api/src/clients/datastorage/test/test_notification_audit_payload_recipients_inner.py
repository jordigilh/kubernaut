...
class TestNotificationAuditPayloadRecipientsInner(unittest.TestCase):
    """NotificationAuditPayloadRecipientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationAuditPayloadRecipientsInner:
        """Test NotificationAuditPayloadRecipientsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationAuditPayloadRecipientsInner`
        """
        model = NotificationAuditPayloadRecipientsInner()
        if include_optional:
            return NotificationAuditPayloadRecipientsInner(
    ...
    def testNotificationAuditPayloadRecipientsInner(self):
        """Test NotificationAuditPayloadRecipientsInner"""
