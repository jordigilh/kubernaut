...
class TestLLMToolCallPayload(unittest.TestCase):
    """LLMToolCallPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LLMToolCallPayload:
        """Test LLMToolCallPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LLMToolCallPayload`
        """
    ...
    def testLLMToolCallPayload(self):
        """Test LLMToolCallPayload"""
