...
class EffectivenessComponents(BaseModel):
    """
    Individual component assessment scores.
    """ # noqa: E501
    health_assessed: Optional[StrictBool] = Field(default=None, description="Whether health component has been assessed.")
    health_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Health pass rate score (0.0 to 1.0).")
    health_details: Optional[StrictStr] = Field(default=None, description="Human-readable health assessment details.")
    alert_assessed: Optional[StrictBool] = Field(default=None, description="Whether alert component has been assessed.")
    alert_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Alert resolution score (0.0 to 1.0).")
    alert_details: Optional[StrictStr] = Field(default=None, description="Human-readable alert assessment details.")
    metrics_assessed: Optional[StrictBool] = Field(default=None, description="Whether metrics component has been assessed.")
    metrics_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Metric improvement ratio score (0.0 to 1.0).")
    metrics_details: Optional[StrictStr] = Field(default=None, description="Human-readable metrics assessment details.")
    __properties: ClassVar[List[str]] = ["health_assessed", "health_score", "health_details", "alert_assessed", "alert_score", "alert_details", "metrics_assessed", "metrics_score", "metrics_details"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if health_score (nullable) is None
        # and model_fields_set contains the field
        if self.health_score is None and "health_score" in self.model_fields_set:
            _dict['health_score'] = None

        # set to None if alert_score (nullable) is None
        # and model_fields_set contains the field
        if self.alert_score is None and "alert_score" in self.model_fields_set:
            _dict['alert_score'] = None

        # set to None if metrics_score (nullable) is None
        # and model_fields_set contains the field
        if self.metrics_score is None and "metrics_score" in self.model_fields_set:
            _dict['metrics_score'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "health_assessed": obj.get("health_assessed"),
            "health_score": obj.get("health_score"),
            "health_details": obj.get("health_details"),
            "alert_assessed": obj.get("alert_assessed"),
            "alert_score": obj.get("alert_score"),
            "alert_details": obj.get("alert_details"),
            "metrics_assessed": obj.get("metrics_assessed"),
            "metrics_score": obj.get("metrics_score"),
            "metrics_details": obj.get("metrics_details")
        })
        return _obj
