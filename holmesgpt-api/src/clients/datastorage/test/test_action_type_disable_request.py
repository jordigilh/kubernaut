...
class TestActionTypeDisableRequest(unittest.TestCase):
    """ActionTypeDisableRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeDisableRequest:
        """Test ActionTypeDisableRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeDisableRequest`
        """
        model = ActionTypeDisableRequest()
        if include_optional:
            return ActionTypeDisableRequest(
                disabled_by = ''
            )
        else:
            return ActionTypeDisableRequest(
    ...
    def testActionTypeDisableRequest(self):
        """Test ActionTypeDisableRequest"""
