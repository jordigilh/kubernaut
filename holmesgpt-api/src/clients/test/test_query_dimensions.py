...
class TestQueryDimensions(unittest.TestCase):
    """QueryDimensions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryDimensions:
        """Test QueryDimensions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryDimensions`
        """
        model = QueryDimensions()
        if include_optional:
