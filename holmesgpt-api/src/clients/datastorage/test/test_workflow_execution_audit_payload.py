...
class TestWorkflowExecutionAuditPayload(unittest.TestCase):
    """WorkflowExecutionAuditPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowExecutionAuditPayload:
        """Test WorkflowExecutionAuditPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowExecutionAuditPayload`
        """
    ...
    def testWorkflowExecutionAuditPayload(self):
        """Test WorkflowExecutionAuditPayload"""
