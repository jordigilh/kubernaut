...
class RemediationWorkflow(BaseModel):
    ...
    RemediationWorkflow
    """ # noqa: E501
    workflow_id: Optional[UUID] = Field(default=None, description="Unique workflow identifier (UUID, auto-generated)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "labels": MandatoryLabels.from_dict(obj["labels"]) if obj.get("labels") is not None else None,
            "custom_labels": obj.get("custom_labels"),
            "detected_labels": DetectedLabels.from_dict(obj["detected_labels"]) if obj.get("detected_labels") is not None else None,
