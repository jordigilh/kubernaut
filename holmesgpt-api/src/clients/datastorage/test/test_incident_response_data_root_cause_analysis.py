...
class TestIncidentResponseDataRootCauseAnalysis(unittest.TestCase):
    """IncidentResponseDataRootCauseAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentResponseDataRootCauseAnalysis:
        """Test IncidentResponseDataRootCauseAnalysis
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentResponseDataRootCauseAnalysis`
        """
        model = IncidentResponseDataRootCauseAnalysis()
        if include_optional:
            return IncidentResponseDataRootCauseAnalysis(
                summary = '',
                severity = 'high',
    ...
    def testIncidentResponseDataRootCauseAnalysis(self):
        """Test IncidentResponseDataRootCauseAnalysis"""
