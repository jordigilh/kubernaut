...
class ActionTypeListResponse(BaseModel):
    ...
    """ # noqa: E501
    action_types: List[ActionTypeEntry] = Field(alias="actionTypes")
    pagination: PaginationMetadata
    __properties: ClassVar[List[str]] = ["actionTypes", "pagination"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.action_types:
            for _item in self.action_types:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "actionTypes": [ActionTypeEntry.from_dict(_item) for _item in obj.get("actionTypes")] if obj.get("actionTypes") is not None else None,
