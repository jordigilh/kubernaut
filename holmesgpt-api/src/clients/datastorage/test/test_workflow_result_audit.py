...
class TestWorkflowResultAudit(unittest.TestCase):
    """WorkflowResultAudit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResultAudit:
        """Test WorkflowResultAudit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResultAudit`
        """
        model = WorkflowResultAudit()
        if include_optional:
            return WorkflowResultAudit(
    ...
    def testWorkflowResultAudit(self):
        """Test WorkflowResultAudit"""
