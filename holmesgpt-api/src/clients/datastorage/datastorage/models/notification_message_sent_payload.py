...
class NotificationMessageSentPayload(BaseModel):
    """
    Message sent event payload (notification.message.sent)
    """ # noqa: E501
    notification_id: StrictStr = Field(description="Name of the NotificationRequest CRD")
    channel: StrictStr = Field(description="Delivery channel")
    subject: StrictStr = Field(description="Notification subject line")
    body: StrictStr = Field(description="Notification message body")
    priority: StrictStr = Field(description="Notification priority level")
    type: StrictStr = Field(description="Notification type")
    metadata: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["notification_id", "channel", "subject", "body", "priority", "type", "metadata"]
