...
func NewEffectivenessAssessmentCreator(c client.Client, s *runtime.Scheme, m *metrics.Metrics, stabilizationWindow time.Duration) *EffectivenessAssessmentCreator {
