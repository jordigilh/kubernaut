...
class TestProviderResponseSummary(unittest.TestCase):
    """ProviderResponseSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProviderResponseSummary:
        """Test ProviderResponseSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProviderResponseSummary`
        """
        model = ProviderResponseSummary()
        if include_optional:
    ...
    def testProviderResponseSummary(self):
        """Test ProviderResponseSummary"""
