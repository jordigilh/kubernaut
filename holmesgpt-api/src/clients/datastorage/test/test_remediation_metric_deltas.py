...
class TestRemediationMetricDeltas(unittest.TestCase):
    """RemediationMetricDeltas unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationMetricDeltas:
        """Test RemediationMetricDeltas
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationMetricDeltas`
        """
        model = RemediationMetricDeltas()
        if include_optional:
            return RemediationMetricDeltas(
                cpu_before = 0.95,
                cpu_after = 0.92,
                memory_before = 0.6,
                memory_after = 0.62,
    ...
    def testRemediationMetricDeltas(self):
        """Test RemediationMetricDeltas"""
