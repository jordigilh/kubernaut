...
// decorator applied by newAnthropicModel/newVertexAIModel) and, if so, its
// configured timeout. Lets black-box (launcher_test) specs prove the
// decorator is wired into NewModelFromConfig's real construction sites
