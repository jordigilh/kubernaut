...
class TestRemediationHistoryEntry(unittest.TestCase):
    """RemediationHistoryEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationHistoryEntry:
        """Test RemediationHistoryEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationHistoryEntry`
        """
        model = RemediationHistoryEntry()
        if include_optional:
    ...
    def testRemediationHistoryEntry(self):
        """Test RemediationHistoryEntry"""
