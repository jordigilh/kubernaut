...
func (s *RemediationWorkflowContentLabels) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *RemediationWorkflowContentParameter) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *RemediationWorkflowContentPayload) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	if err := func() error {
		var failures []validate.FieldError
		for i, elem := range s.RollbackParameters {
			if err := func() error {
				if err := elem.Validate(); err != nil {
					return err
				}
...
func (s *RemediationWorkflowWebhookAuditPayload) Validate() error {
	...
	if err := func() error {
		if value, ok := s.WorkflowContent.Get(); ok {
			if err := func() error {
				if err := value.Validate(); err != nil {
					return err
				}
...
func (s *ShadowLLMRequestPayload) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s ShadowLLMRequestPayloadEventType) Validate() error {
	switch s {
...
func (s *ShadowLLMResponsePayload) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	if err := func() error {
		if err := (validate.Int{
			...
			MultipleOf:    0,
			Pattern:       nil,
		}).Validate(int64(s.PromptTokens)); err != nil {
			return errors.Wrap(err, "int")
		}
		return nil
	}(); err != nil {
	...
	if err := func() error {
		if err := (validate.Int{
			...
			MultipleOf:    0,
			Pattern:       nil,
		}).Validate(int64(s.CompletionTokens)); err != nil {
			return errors.Wrap(err, "int")
		}
		return nil
	}(); err != nil {
	...
	if err := func() error {
		if value, ok := s.EvaluationResult.Get(); ok {
			if err := func() error {
				if err := value.Validate(); err != nil {
					return err
				}
...
func (s ShadowLLMResponsePayloadEvaluationResult) Validate() error {
	switch s {
	case "success":
		return nil
...
func (s ShadowLLMResponsePayloadEventType) Validate() error {
	switch s {
