...
|-----------|-------|-----------|
| **max_connections** | 100 | 20 (Data Storage) + 50 (Kubernaut Agent (KA)) + 30 (other services) |
...
2. **Read Replicas**: Add PostgreSQL read replica for KA queries - **Reduces write contention**
