...
class ReconstructionResponse(BaseModel):
    ...
    """ # noqa: E501
    remediation_request_yaml: StrictStr = Field(description="Complete RemediationRequest CRD in YAML format. Can be applied directly to Kubernetes cluster with kubectl. Includes TypeMeta, ObjectMeta, Spec, and Status. ")
    validation: ValidationResult
    reconstructed_at: Optional[datetime] = Field(default=None, description="Timestamp when reconstruction was performed. ")
    correlation_id: Optional[StrictStr] = Field(default=None, description="Correlation ID used for reconstruction. ")
    __properties: ClassVar[List[str]] = ["remediation_request_yaml", "validation", "reconstructed_at", "correlation_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "remediation_request_yaml": obj.get("remediation_request_yaml"),
            "validation": ValidationResult.from_dict(obj.get("validation")) if obj.get("validation") is not None else None,
            "reconstructed_at": obj.get("reconstructed_at"),
