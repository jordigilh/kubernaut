...
class TestNotificationMessageFailedPayload(unittest.TestCase):
    """NotificationMessageFailedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationMessageFailedPayload:
        """Test NotificationMessageFailedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationMessageFailedPayload`
        """
        model = NotificationMessageFailedPayload()
        if include_optional:
            return NotificationMessageFailedPayload(
                notification_id = '',
                channel = '',
                subject = '',
                body = '',
    ...
    def testNotificationMessageFailedPayload(self):
        """Test NotificationMessageFailedPayload"""
