...
**Rollout**: implemented on `release/v1.5` first (branch `fix/1918-harness-actionability-gate-v1.5`, tracked by #1918), to be backported to `main` afterward (tracked by #1924).
