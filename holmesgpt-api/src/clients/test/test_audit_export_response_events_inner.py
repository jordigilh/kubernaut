...
class TestAuditExportResponseEventsInner(unittest.TestCase):
    """AuditExportResponseEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditExportResponseEventsInner:
        """Test AuditExportResponseEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditExportResponseEventsInner`
        """
        model = AuditExportResponseEventsInner()
        if include_optional:
            return AuditExportResponseEventsInner(
                event_id = '',
                version = '',
                event_type = '',
    ...
    def testAuditExportResponseEventsInner(self):
        """Test AuditExportResponseEventsInner"""
