...
> |---------|------|---------|-----------|
> | v1.5 | 2025-11-30 | Updated to DD-WORKFLOW-001 v1.7 (snake_case API fields, DetectedLabels wildcard support) | [HANDOFF_REQUEST_REGO_LABEL_EXTRACTION.md](HANDOFF_REQUEST_REGO_LABEL_EXTRACTION.md) v3.1, [DD-WORKFLOW-001 v1.7](../../../architecture/decisions/DD-WORKFLOW-001-mandatory-label-schema.md) |
...
> **Label Taxonomy**: 5 mandatory labels (DD-WORKFLOW-001 v1.7) + Customer-Derived Labels (Rego) + DetectedLabels
