...
func (s *AlignmentFinding) Validate() error {
	if s == nil {
	...
	if err := func() error {
		if err := s.StepKind.Validate(); err != nil {
			return err
		}
		return nil
	}(); err != nil {
...
func (s AlignmentFindingStepKind) Validate() error {
	switch s {
	case "llm_reasoning":
		return nil
	case "tool_result":
...
func (s *AlignmentVerdict) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s AlignmentVerdictResult) Validate() error {
	switch s {
	case "aligned":
		return nil
	case "suspicious":
...
func (s *IncidentResponse) Validate() error {
	...
	if err := func() error {
		if value, ok := s.AlignmentVerdict.Get(); ok {
			if err := func() error {
				if err := value.Validate(); err != nil {
					return err
				}
