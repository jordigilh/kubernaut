...
ALTER TABLE action_type_taxonomy ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'active';
ALTER TABLE action_type_taxonomy ADD COLUMN IF NOT EXISTS disabled_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE action_type_taxonomy ADD COLUMN IF NOT EXISTS disabled_by TEXT;
...
ALTER TABLE action_type_taxonomy DROP COLUMN IF EXISTS disabled_by;
ALTER TABLE action_type_taxonomy DROP COLUMN IF EXISTS disabled_at;
ALTER TABLE action_type_taxonomy DROP COLUMN IF EXISTS status;
