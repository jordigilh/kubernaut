...
class TestSearchExecutionMetadata(unittest.TestCase):
    """SearchExecutionMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchExecutionMetadata:
        """Test SearchExecutionMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchExecutionMetadata`
        """
    ...
    def testSearchExecutionMetadata(self):
        """Test SearchExecutionMetadata"""
