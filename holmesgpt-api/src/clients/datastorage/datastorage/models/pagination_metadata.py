...
class PaginationMetadata(BaseModel):
    ...
    """ # noqa: E501
    total_count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of results across all pages", alias="totalCount")
    offset: Annotated[int, Field(strict=True, ge=0)] = Field(description="Current offset (0-based)")
    limit: Annotated[int, Field(strict=True, ge=1)] = Field(description="Page size")
    has_more: StrictBool = Field(description="True if more pages exist beyond current offset+limit", alias="hasMore")
    __properties: ClassVar[List[str]] = ["totalCount", "offset", "limit", "hasMore"]
