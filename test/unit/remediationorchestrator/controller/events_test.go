...
func (m *MockBlockingRoutingEngine) CheckPostAnalysisConditions(ctx context.Context, rr *remediationv1.RemediationRequest, workflowID string, targetResource string, preRemediationSpecHash string, workflowType string) (*routing.BlockingCondition, error) {
	if m.BlockCondition != nil {
		return &routing.BlockingCondition{
			Blocked:      true,
			Reason:       m.BlockCondition.Reason,
