...
class TestRemediationHealthChecks(unittest.TestCase):
    """RemediationHealthChecks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationHealthChecks:
        """Test RemediationHealthChecks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationHealthChecks`
        """
        model = RemediationHealthChecks()
        if include_optional:
            return RemediationHealthChecks(
                pod_running = True,
                readiness_pass = True,
                restart_delta = 0,
                crash_loops = False,
    ...
    def testRemediationHealthChecks(self):
        """Test RemediationHealthChecks"""
