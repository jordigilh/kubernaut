...
class ActionTypeCatalogCreatedPayload(BaseModel):
    """
    DS audit payload when a new action type is created or re-enabled
    """ # noqa: E501
    event_type: StrictStr
    action_type: StrictStr
    description: ActionTypeDescriptionPayload
    registered_by: StrictStr
    was_reenabled: StrictBool
    __properties: ClassVar[List[str]] = ["event_type", "action_type", "description", "registered_by", "was_reenabled"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('datastorage.actiontype.created'):
            raise ValueError("must be one of enum values ('datastorage.actiontype.created')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "description": ActionTypeDescriptionPayload.from_dict(obj.get("description")) if obj.get("description") is not None else None,
            "registered_by": obj.get("registered_by"),
            "was_reenabled": obj.get("was_reenabled")
        })
        return _obj
