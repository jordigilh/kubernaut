...
------------ | ------------- | ------------- | -------------
**workflow_id** | **UUID** | Unique workflow identifier (UUID, auto-generated) | [optional] 
...
remediation_workflow_from_dict = RemediationWorkflow.from_dict(remediation_workflow_dict)
```
