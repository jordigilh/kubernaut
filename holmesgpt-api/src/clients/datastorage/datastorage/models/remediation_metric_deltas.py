...
class RemediationMetricDeltas(BaseModel):
    """
    Metric deltas between pre-remediation and post-remediation measurements. 
    """ # noqa: E501
    cpu_before: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CPU utilization before remediation (0.0-1.0)", alias="cpuBefore")
    cpu_after: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CPU utilization after remediation (0.0-1.0)", alias="cpuAfter")
    memory_before: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Memory utilization before remediation (0.0-1.0)", alias="memoryBefore")
    memory_after: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Memory utilization after remediation (0.0-1.0)", alias="memoryAfter")
    latency_p95_before_ms: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="P95 latency before remediation (milliseconds)", alias="latencyP95BeforeMs")
    latency_p95_after_ms: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="P95 latency after remediation (milliseconds)", alias="latencyP95AfterMs")
    error_rate_before: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Error rate before remediation (0.0-1.0)", alias="errorRateBefore")
    error_rate_after: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Error rate after remediation (0.0-1.0)", alias="errorRateAfter")
    __properties: ClassVar[List[str]] = ["cpuBefore", "cpuAfter", "memoryBefore", "memoryAfter", "latencyP95BeforeMs", "latencyP95AfterMs", "errorRateBefore", "errorRateAfter"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "cpuBefore": obj.get("cpuBefore"),
            "cpuAfter": obj.get("cpuAfter"),
            "memoryBefore": obj.get("memoryBefore"),
            "memoryAfter": obj.get("memoryAfter"),
            "latencyP95BeforeMs": obj.get("latencyP95BeforeMs"),
            "latencyP95AfterMs": obj.get("latencyP95AfterMs"),
            "errorRateBefore": obj.get("errorRateBefore"),
            "errorRateAfter": obj.get("errorRateAfter")
        })
        return _obj
