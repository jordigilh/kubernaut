...
// reconcilerMockK8sEnricher is a local mock for this file (avoids collision with mocks_test.go).
type reconcilerMockK8sEnricher struct {
...
func (m *reconcilerMockK8sEnricher) Enrich(ctx context.Context, signal *signalprocessingv1alpha1.SignalData) (*signalprocessingv1alpha1.KubernetesContext, error) {
	if m.EnrichFunc != nil {
...
var _ = Describe("BR-SP-090/ADR-032: Audit Client Mandatory Enforcement", func() {
	...
	Context("AM-MAN-01: When is nil", func() {
		It("should fail reconciliation instead of silently skipping audit", func() {
			...
			mockEnricher := &reconcilerMockK8sEnricher{
				EnrichFunc: func(ctx context.Context, signal *signalprocessingv1alpha1.SignalData) (*signalprocessingv1alpha1.KubernetesContext, error) {
