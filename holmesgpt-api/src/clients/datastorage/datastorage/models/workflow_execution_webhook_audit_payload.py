...
class WorkflowExecutionWebhookAuditPayload(BaseModel):
    ...
    clear_reason: StrictStr = Field(description="Reason for clearing the block")
    cleared_at: datetime = Field(description="When the block was cleared")
    previous_state: StrictStr = Field(description="State before unblocking (always \"Blocked\")")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "clear_reason": obj.get("clear_reason"),
