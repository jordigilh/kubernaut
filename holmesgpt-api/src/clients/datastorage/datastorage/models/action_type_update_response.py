...
class ActionTypeUpdateResponse(BaseModel):
    """
    Response for action type description update
    """ # noqa: E501
    action_type: StrictStr = Field(alias="actionType")
    old_description: ActionTypeDescription = Field(alias="oldDescription")
    new_description: ActionTypeDescription = Field(alias="newDescription")
    updated_fields: List[StrictStr] = Field(description="List of changed field names", alias="updatedFields")
    __properties: ClassVar[List[str]] = ["actionType", "oldDescription", "newDescription", "updatedFields"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "oldDescription": ActionTypeDescription.from_dict(obj.get("oldDescription")) if obj.get("oldDescription") is not None else None,
            "newDescription": ActionTypeDescription.from_dict(obj.get("newDescription")) if obj.get("newDescription") is not None else None,
