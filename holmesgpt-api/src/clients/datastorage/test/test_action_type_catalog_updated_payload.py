...
class TestActionTypeCatalogUpdatedPayload(unittest.TestCase):
    """ActionTypeCatalogUpdatedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeCatalogUpdatedPayload:
        """Test ActionTypeCatalogUpdatedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeCatalogUpdatedPayload`
        """
        model = ActionTypeCatalogUpdatedPayload()
        if include_optional:
            return ActionTypeCatalogUpdatedPayload(
                event_type = 'datastorage.actiontype.updated',
                action_type = '',
    ...
    def testActionTypeCatalogUpdatedPayload(self):
        """Test ActionTypeCatalogUpdatedPayload"""
