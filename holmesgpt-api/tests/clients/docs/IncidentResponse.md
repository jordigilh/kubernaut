...
**target_in_owner_chain** | **bool** | Whether RCA-identified target resource was found in OwnerChain. If false, DetectedLabels may be from different scope than affected resource. | [optional] [default to True]
**warnings** | **List[str]** | Non-fatal warnings (e.g., OwnerChain validation issues, low confidence) | [optional] 
