...
class TestAIAgentEnrichmentFailedPayload(unittest.TestCase):
    """AIAgentEnrichmentFailedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAgentEnrichmentFailedPayload:
        """Test AIAgentEnrichmentFailedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAgentEnrichmentFailedPayload`
        """
        model = AIAgentEnrichmentFailedPayload()
        if include_optional:
            return AIAgentEnrichmentFailedPayload(
                event_type = 'aiagent.enrichment.failed',
                event_id = 'evt-enrich-fail-abc123',
                incident_id = 'incident-payment-api-2026-03-04-abc123',
                reason = 'rca_incomplete',
                detail = 'resolve_owner_chain failed after 3 retries: ConnectionError',
                affected_resource_kind = 'Pod',
                affected_resource_name = 'api-xyz-12345',
                affected_resource_namespace = 'production'
            )
        else:
            return AIAgentEnrichmentFailedPayload(
                event_type = 'aiagent.enrichment.failed',
    ...
    def testAIAgentEnrichmentFailedPayload(self):
        """Test AIAgentEnrichmentFailedPayload"""
