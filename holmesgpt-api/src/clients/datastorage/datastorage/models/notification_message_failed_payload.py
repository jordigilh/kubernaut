...
class NotificationMessageFailedPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["notification_id", "channel", "subject", "body", "priority", "error_type", "error", "metadata"]
