...
class TestActionTypeWebhookAuditPayload(unittest.TestCase):
    """ActionTypeWebhookAuditPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeWebhookAuditPayload:
        """Test ActionTypeWebhookAuditPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeWebhookAuditPayload`
        """
        model = ActionTypeWebhookAuditPayload()
        if include_optional:
            return ActionTypeWebhookAuditPayload(
    ...
    def testActionTypeWebhookAuditPayload(self):
        """Test ActionTypeWebhookAuditPayload"""
