...
class TestWorkflowCatalogUpdatedPayload(unittest.TestCase):
    """WorkflowCatalogUpdatedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowCatalogUpdatedPayload:
        """Test WorkflowCatalogUpdatedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowCatalogUpdatedPayload`
        """
        model = WorkflowCatalogUpdatedPayload()
        if include_optional:
    ...
    def testWorkflowCatalogUpdatedPayload(self):
        """Test WorkflowCatalogUpdatedPayload"""
