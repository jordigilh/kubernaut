...
func severityToScore(severity actionhistory.OscillationSeverity) int {
	switch severity {
	case actionhistory.SeverityCritical: return 4
	case actionhistory.SeverityHigh: return 3
	case actionhistory.SeverityMedium: return 2
	case actionhistory.SeverityLow: return 1
	default: return 0
	}
}
...
// getResourceID is no longer needed as the stored procedure handles resource management
// Keeping for backward compatibility if needed elsewhere
func (e *OscillationDetectionEngine) getResourceID(ctx context.Context, resourceRef actionhistory.ResourceReference) (int64, error) {
