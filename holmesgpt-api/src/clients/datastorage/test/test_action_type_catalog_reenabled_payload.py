...
class TestActionTypeCatalogReenabledPayload(unittest.TestCase):
    """ActionTypeCatalogReenabledPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeCatalogReenabledPayload:
        """Test ActionTypeCatalogReenabledPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeCatalogReenabledPayload`
        """
        model = ActionTypeCatalogReenabledPayload()
        if include_optional:
            return ActionTypeCatalogReenabledPayload(
    ...
    def testActionTypeCatalogReenabledPayload(self):
        """Test ActionTypeCatalogReenabledPayload"""
