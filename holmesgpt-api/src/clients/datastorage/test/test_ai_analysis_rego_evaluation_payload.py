...
class TestAIAnalysisRegoEvaluationPayload(unittest.TestCase):
    """AIAnalysisRegoEvaluationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAnalysisRegoEvaluationPayload:
        """Test AIAnalysisRegoEvaluationPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAnalysisRegoEvaluationPayload`
        """
        model = AIAnalysisRegoEvaluationPayload()
        if include_optional:
            return AIAnalysisRegoEvaluationPayload(
                outcome = 'allow',
                degraded = False,
                duration_ms = 50,
                reason = 'Policy allows auto-approval for non-production'
            )
        else:
            return AIAnalysisRegoEvaluationPayload(
                outcome = 'allow',
    ...
    def testAIAnalysisRegoEvaluationPayload(self):
        """Test AIAnalysisRegoEvaluationPayload"""
