	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "api/v1/"
				...
				case 'p': // Prefix: "postexec/analyze"

					if l := len("postexec/analyze"); len(elem) >= l && elem[0:l] == "postexec/analyze" {
						elem = elem[l:]
					} else {
						break
					}
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handlePostexecAnalyzeEndpointAPIV1PostexecAnalyzePostRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "POST")
						}
			...
			case 'a': // Prefix: "api/v1/"
				...
				case 'p': // Prefix: "postexec/analyze"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = PostexecAnalyzeEndpointAPIV1PostexecAnalyzePostOperation
							r.summary = "Postexec Analyze Endpoint"
							r.operationID = "postexec_analyze_endpoint_api_v1_postexec_analyze_post"
							r.operationGroup = ""
							r.pathPattern = "/api/v1/postexec/analyze"
							r.args = args
							r.count = 0
							return r, true
						default:
