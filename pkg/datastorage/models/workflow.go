...
type WorkflowSearchRequest struct {
	...
	// Embedding is the vector representation of the query (768 dimensions per migration 016)
...
type WorkflowSearchResult struct {
	...
	// Confidence is the final weighted score (0.0-1.0) - DD-WORKFLOW-002 v3.0 name
	// Alias for FinalScore for API contract compliance
	...
	// Max: 0.10 (resource_management) + 0.10 (gitops_tool) + 0.08 (environment) + 0.08 (business_category) + 0.05 (priority) + 0.05 (risk_tolerance) = 0.46
	...
	// Max: 0.10 (resource_management) + 0.10 (gitops_tool) = 0.20
