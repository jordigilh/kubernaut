...
class TestActionTypeDescription(unittest.TestCase):
    """ActionTypeDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeDescription:
        """Test ActionTypeDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeDescription`
        """
        model = ActionTypeDescription()
        if include_optional:
    ...
    def testActionTypeDescription(self):
        """Test ActionTypeDescription"""
