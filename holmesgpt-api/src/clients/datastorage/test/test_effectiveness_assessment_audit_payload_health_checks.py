...
class TestEffectivenessAssessmentAuditPayloadHealthChecks(unittest.TestCase):
    """EffectivenessAssessmentAuditPayloadHealthChecks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectivenessAssessmentAuditPayloadHealthChecks:
        """Test EffectivenessAssessmentAuditPayloadHealthChecks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectivenessAssessmentAuditPayloadHealthChecks`
        """
        model = EffectivenessAssessmentAuditPayloadHealthChecks()
        if include_optional:
            return EffectivenessAssessmentAuditPayloadHealthChecks(
                pod_running = True,
                readiness_pass = True,
                total_replicas = 3,
                ready_replicas = 3,
    ...
    def testEffectivenessAssessmentAuditPayloadHealthChecks(self):
        """Test EffectivenessAssessmentAuditPayloadHealthChecks"""
