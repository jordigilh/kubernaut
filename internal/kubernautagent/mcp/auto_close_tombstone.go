...
// existing disconnectGracePeriod (#2076, v1.6 clone of #2075) used
// elsewhere in the interactive session lifecycle.
const defaultAutoCloseTombstoneTTL = 60 * time.Second

// AutoCloseTombstone is a small, self-expiring record of interactive
// sessions the backend recently auto-closed on its own (#2076, v1.6 clone
// of #2075).
//
// investigate_discovery.go's no_matching_workflows handling releases the
// MCP interactive lease asynchronously, in a goroutine, after the
