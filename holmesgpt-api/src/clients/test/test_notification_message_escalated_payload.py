...
class TestNotificationMessageEscalatedPayload(unittest.TestCase):
    """NotificationMessageEscalatedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationMessageEscalatedPayload:
        """Test NotificationMessageEscalatedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationMessageEscalatedPayload`
        """
        model = NotificationMessageEscalatedPayload()
        if include_optional:
            return NotificationMessageEscalatedPayload(
                notification_id = '',
                subject = '',
                priority = '',
                reason = '',
    ...
    def testNotificationMessageEscalatedPayload(self):
        """Test NotificationMessageEscalatedPayload"""
