...
|---------|--------|---------|-------------------|
| **Signal Processing** | ✅ v1.0 | Signal enrichment with K8s context | 87.9% |
| **Remediation Orchestrator** | ✅ v1.0 | Cross-CRD lifecycle coordination | 82.9% |
| **AI Analysis** | ✅ v1.0 | AI-powered analysis & recommendations | 82.1% |
| **Gateway** | ✅ v1.0 | Signal ingestion & deduplication | 80.0% |
| **Notification** | ✅ v1.0 | Multi-channel delivery | 71.2% |
| **Workflow Execution** | ✅ v1.0 | Tekton workflow orchestration | 66.9% |
| **Data Storage** | ✅ v1.0 | REST API for PostgreSQL (ADR-032) | 60.5% |
| **HolmesGPT API** | ✅ v3.10 | AI investigation wrapper | 60.4% |
...
|---------|---------------|-------------|-----|-----------|
| **Signal Processing** | 82.1% | 58.6% | 57.7% | 87.9% |
| **Remediation Orchestrator** | 75.8% | 57.7% | — | 82.9% |
| **AI Analysis** | 71.7% | 67.8% | — | 82.1% |
| **Gateway** | 65.2% | 41.7% | 58.4% | 80.0% |
| **Notification** | 78.8% | 46.8% | — | 71.2% |
| **Workflow Execution** | 44.9% | 71.8% | 62.1% | 66.9% |
| **Data Storage** | 58.3% | 34.0% | 44.8% | 60.5% |
| **HolmesGPT API** | 76.0% | 43.5% | 18.1% | 60.4% |
| **Auth Webhook** | 50.0% | 48.4% | — | 54.5% |
