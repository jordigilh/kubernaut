...
class LLMRequestPayload(BaseModel):
    ...
    prompt_length: Annotated[int, Field(strict=True, ge=0)] = Field(description="Length of prompt sent to LLM")
    prompt_preview: StrictStr = Field(description="First 500 characters of prompt for audit")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "model": obj.get("model"),
            "prompt_length": obj.get("prompt_length"),
            "prompt_preview": obj.get("prompt_preview"),
            "max_tokens": obj.get("max_tokens"),
            "toolsets_enabled": obj.get("toolsets_enabled"),
