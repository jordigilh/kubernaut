...
def create_incident_investigation_prompt(
    ...
    if signal_mode == "predictive":
        incident_summary = f"A **{severity} {signal_type} event** from **{signal_source}** has been **predicted** for **{namespace}/{resource_kind}/{resource_name}**. This incident has NOT yet occurred — it is based on resource trend analysis (e.g., Prometheus predict_linear())."
    else:
...
that a **{signal_type}** event will occur for **{namespace}/{resource_kind}/{resource_name}**.
