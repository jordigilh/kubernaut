...
class TestActionTypeListResponse(unittest.TestCase):
    """ActionTypeListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeListResponse:
        """Test ActionTypeListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeListResponse`
        """
        model = ActionTypeListResponse()
        if include_optional:
    ...
    def testActionTypeListResponse(self):
        """Test ActionTypeListResponse"""
