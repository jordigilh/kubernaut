...
class TestAIAgentEnrichmentCompletedPayload(unittest.TestCase):
    """AIAgentEnrichmentCompletedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAgentEnrichmentCompletedPayload:
        """Test AIAgentEnrichmentCompletedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAgentEnrichmentCompletedPayload`
        """
        model = AIAgentEnrichmentCompletedPayload()
        if include_optional:
            return AIAgentEnrichmentCompletedPayload(
                event_type = 'aiagent.enrichment.completed',
                event_id = 'evt-enrich-ok-abc123',
                ...
                detected_labels_summary = {"gitOpsManaged":true,"pdbProtected":false,"hpaEnabled":true},
    ...
    def testAIAgentEnrichmentCompletedPayload(self):
        """Test AIAgentEnrichmentCompletedPayload"""
