...
class TestAuditEventStructure:
    ...
    def test_llm_request_event_structure(self):
        ...
        envelope_fields = [
            "version", "service", "event_type", "event_timestamp",
            "correlation_id", "operation", "outcome", "event_data"
        ]
        ...
        assert event["operation"] == "llm_request_sent"
    ...
    def test_llm_response_event_structure(self):
        ...
        assert event["operation"] == "llm_response_received"
        assert event["outcome"] == "success"  # has_analysis=True
    ...
    def test_validation_attempt_event_structure(self):
        ...
        assert event["operation"] == "validation_executed"
        assert event["outcome"] == "pending"  # Will retry (attempt 1 of 3)
    ...
    def test_tool_call_event_structure(self):
        ...
        assert event["operation"] == "tool_invoked"
        assert event["outcome"] == "success"
