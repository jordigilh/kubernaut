...
func encodeDeprecateWorkflowResponse(response DeprecateWorkflowRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	...
	case *DeprecateWorkflowBadRequest:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *DeprecateWorkflowNotFound:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(404)
...
func encodeDisableActionTypeResponse(response DisableActionTypeRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *DisableActionTypeBadRequest:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *DisableActionTypeNotFound:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(404)
		span.SetStatus(codes.Error, http.StatusText(404))
	...
	case *DisableActionTypeInternalServerError:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
...
func encodeDisableWorkflowResponse(response DisableWorkflowRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *DisableWorkflowBadRequest:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
...
func encodeEnableWorkflowResponse(response EnableWorkflowRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *RemediationWorkflow:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
