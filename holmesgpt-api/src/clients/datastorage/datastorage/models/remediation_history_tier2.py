...
class RemediationHistoryTier2(BaseModel):
    """
    ...
    """ # noqa: E501
    window: StrictStr = Field(description="Lookback window used for this tier (e.g. \"2160h\")")
    chain: List[RemediationHistorySummary] = Field(description="Ordered list of summary remediation entries (ascending by completedAt)")
    __properties: ClassVar[List[str]] = ["window", "chain"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "chain": [RemediationHistorySummary.from_dict(_item) for _item in obj.get("chain")] if obj.get("chain") is not None else None
        })
        return _obj
