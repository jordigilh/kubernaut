...
**Related**: [kubernaut-console#47](https://github.com/jordigilh/kubernaut-console/issues/47) (Console welcome-message keyword clarity for the three modes) and [kubernaut#1918](https://github.com/jordigilh/kubernaut/issues/1918) (deferred spike: expose KA's `IsActionable` signal for harness-deterministic Phase 2 gating) were filed as related follow-ups, out of scope for this fix.
