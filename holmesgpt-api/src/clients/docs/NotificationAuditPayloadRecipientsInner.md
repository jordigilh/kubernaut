...
notification_audit_payload_recipients_inner_from_dict = NotificationAuditPayloadRecipientsInner.from_dict(notification_audit_payload_recipients_inner_dict)
```
