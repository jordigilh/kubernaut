...
class TestNotificationMessageAcknowledgedPayload(unittest.TestCase):
    """NotificationMessageAcknowledgedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationMessageAcknowledgedPayload:
        """Test NotificationMessageAcknowledgedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationMessageAcknowledgedPayload`
        """
        model = NotificationMessageAcknowledgedPayload()
        if include_optional:
            return NotificationMessageAcknowledgedPayload(
                notification_id = '',
                subject = '',
                priority = '',
                metadata = {
    ...
    def testNotificationMessageAcknowledgedPayload(self):
        """Test NotificationMessageAcknowledgedPayload"""
