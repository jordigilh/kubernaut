...
class TestEffectivenessAssessmentAPIApi(unittest.TestCase):
    """EffectivenessAssessmentAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EffectivenessAssessmentAPIApi()

    def tearDown(self) -> None:
        pass

    def test_get_effectiveness_score(self) -> None:
        """Test case for get_effectiveness_score
