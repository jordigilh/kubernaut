...
class TestActionTypeCatalogDisableDeniedPayload(unittest.TestCase):
    """ActionTypeCatalogDisableDeniedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeCatalogDisableDeniedPayload:
        """Test ActionTypeCatalogDisableDeniedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeCatalogDisableDeniedPayload`
        """
        model = ActionTypeCatalogDisableDeniedPayload()
        if include_optional:
            return ActionTypeCatalogDisableDeniedPayload(
                event_type = 'datastorage.actiontype.disable_denied',
                action_type = '',
                denied_reason = '',
    ...
    def testActionTypeCatalogDisableDeniedPayload(self):
        """Test ActionTypeCatalogDisableDeniedPayload"""
