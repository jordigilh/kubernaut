...
func LoadIntegrationTestConfig() IntegrationTestConfig {
	config := IntegrationTestConfig{
		...
		SkipLLMTests:         getBoolEnv("SKIP_LLM_TESTS", false),
...
// Enhanced mock LLM client with realistic responses for integration testing
type MockLLMClientWithRealisticResponses struct {
	responses map[string]*engine.AIWorkflowResponse
}

func NewMockLLMClientWithRealisticResponses() *MockLLMClientWithRealisticResponses {
	client := &MockLLMClientWithRealisticResponses{
...
func (m *MockLLMClientWithRealisticResponses) AnalyzeAlert(ctx context.Context, alert types.Alert) (*types.ActionRecommendation, error) {
...
func (m *MockLLMClientWithRealisticResponses) ChatCompletion(ctx context.Context, prompt string) (string, error) {
	// Simple mock chat completion
	return "Mock chat completion response for integration testing", nil
}

func (m *MockLLMClientWithRealisticResponses) IsHealthy() bool {
	return true
}

func (m *MockLLMClientWithRealisticResponses) GetModelInfo() string {
	return "mock-realistic-model-1.0-integration-test"
}

func (m *MockLLMClientWithRealisticResponses) GenerateWorkflowFromObjective(ctx context.Context, objective *engine.WorkflowObjective) (*engine.AIWorkflowResponse, error) {
