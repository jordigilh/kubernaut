...
class QueryMetadata(BaseModel):
    ...
    """ # noqa: E501
    top_k: StrictInt = Field(description="Maximum number of results to return")
    min_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum similarity score threshold")
    filters: Optional[WorkflowSearchFilters] = None
    __properties: ClassVar[List[str]] = ["top_k", "min_score", "filters"]
