...
func encodePostexecAnalyzeEndpointAPIV1PostexecAnalyzePostResponse(response PostexecAnalyzeEndpointAPIV1PostexecAnalyzePostRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *PostExecResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
