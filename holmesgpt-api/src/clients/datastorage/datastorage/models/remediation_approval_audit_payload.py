...
class RemediationApprovalAuditPayload(BaseModel):
    """
    ...
    request_name: StrictStr = Field(description="Name of the RemediationApprovalRequest")
    decision: StrictStr = Field(description="Approval decision")
    decided_at: datetime = Field(description="When the decision was made")
    decision_message: StrictStr = Field(description="Reason for the decision")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ai_analysis_ref": obj.get("ai_analysis_ref")
        })
        return _obj
