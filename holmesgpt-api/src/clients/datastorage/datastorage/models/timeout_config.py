...
class TimeoutConfig(BaseModel):
    ...
    """ # noqa: E501
    var_global: Optional[StrictStr] = Field(default=None, description="Global timeout (Go duration string, e.g., \"30m\", \"1h\")", alias="global")
    processing: Optional[StrictStr] = Field(default=None, description="Processing phase timeout (Go duration string)")
    analyzing: Optional[StrictStr] = Field(default=None, description="Analyzing phase timeout (Go duration string)")
    executing: Optional[StrictStr] = Field(default=None, description="Executing phase timeout (Go duration string)")
    __properties: ClassVar[List[str]] = ["global", "processing", "analyzing", "executing"]
