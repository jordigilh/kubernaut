...
class TestActionTypeDisableResponse(unittest.TestCase):
    """ActionTypeDisableResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeDisableResponse:
        """Test ActionTypeDisableResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeDisableResponse`
        """
        model = ActionTypeDisableResponse()
        if include_optional:
    ...
    def testActionTypeDisableResponse(self):
        """Test ActionTypeDisableResponse"""
