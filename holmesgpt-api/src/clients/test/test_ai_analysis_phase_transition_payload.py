...
class TestAIAnalysisPhaseTransitionPayload(unittest.TestCase):
    """AIAnalysisPhaseTransitionPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAnalysisPhaseTransitionPayload:
        """Test AIAnalysisPhaseTransitionPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAnalysisPhaseTransitionPayload`
        """
        model = AIAnalysisPhaseTransitionPayload()
        if include_optional:
            return AIAnalysisPhaseTransitionPayload(
    ...
    def testAIAnalysisPhaseTransitionPayload(self):
        """Test AIAnalysisPhaseTransitionPayload"""
