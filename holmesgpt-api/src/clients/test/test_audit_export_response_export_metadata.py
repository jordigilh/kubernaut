...
class TestAuditExportResponseExportMetadata(unittest.TestCase):
    """AuditExportResponseExportMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditExportResponseExportMetadata:
        """Test AuditExportResponseExportMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditExportResponseExportMetadata`
        """
        model = AuditExportResponseExportMetadata()
        if include_optional:
            return AuditExportResponseExportMetadata(
    ...
    def testAuditExportResponseExportMetadata(self):
        """Test AuditExportResponseExportMetadata"""
