...
// Issue #674 Bug 4: AuthWebhook LoadFromFile swallows all errors silently.
// TDD RED phase — this test MUST FAIL before the fix is applied.
var _ = Describe("Issue #674 Bug 4: AuthWebhook LoadFromFile error propagation (BR-PLATFORM-003)", func() {

	It("UT-AW-674-001: nonexistent config file returns error", func() {
