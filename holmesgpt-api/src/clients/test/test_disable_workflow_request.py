...
class TestDisableWorkflowRequest(unittest.TestCase):
    """DisableWorkflowRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisableWorkflowRequest:
        """Test DisableWorkflowRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisableWorkflowRequest`
        """
    ...
    def testDisableWorkflowRequest(self):
        """Test DisableWorkflowRequest"""
