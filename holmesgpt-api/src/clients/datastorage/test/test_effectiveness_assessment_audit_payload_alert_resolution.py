...
class TestEffectivenessAssessmentAuditPayloadAlertResolution(unittest.TestCase):
    """EffectivenessAssessmentAuditPayloadAlertResolution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectivenessAssessmentAuditPayloadAlertResolution:
        """Test EffectivenessAssessmentAuditPayloadAlertResolution
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectivenessAssessmentAuditPayloadAlertResolution`
        """
        model = EffectivenessAssessmentAuditPayloadAlertResolution()
        if include_optional:
            return EffectivenessAssessmentAuditPayloadAlertResolution(
                alert_resolved = True,
                active_count = 0,
    ...
    def testEffectivenessAssessmentAuditPayloadAlertResolution(self):
        """Test EffectivenessAssessmentAuditPayloadAlertResolution"""
