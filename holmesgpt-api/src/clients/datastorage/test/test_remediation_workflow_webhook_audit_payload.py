...
class TestRemediationWorkflowWebhookAuditPayload(unittest.TestCase):
    """RemediationWorkflowWebhookAuditPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationWorkflowWebhookAuditPayload:
        """Test RemediationWorkflowWebhookAuditPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationWorkflowWebhookAuditPayload`
        """
        model = RemediationWorkflowWebhookAuditPayload()
        if include_optional:
            return RemediationWorkflowWebhookAuditPayload(
                event_type = 'remediationworkflow.admitted.create',
    ...
    def testRemediationWorkflowWebhookAuditPayload(self):
        """Test RemediationWorkflowWebhookAuditPayload"""
