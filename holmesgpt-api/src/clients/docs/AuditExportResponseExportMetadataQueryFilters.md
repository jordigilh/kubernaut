...
audit_export_response_export_metadata_query_filters_from_dict = AuditExportResponseExportMetadataQueryFilters.from_dict(audit_export_response_export_metadata_query_filters_dict)
```
