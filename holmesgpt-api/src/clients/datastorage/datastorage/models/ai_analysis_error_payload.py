...
class AIAnalysisErrorPayload(BaseModel):
    """
    Error event payload (aianalysis.error.occurred)
    """ # noqa: E501
    phase: StrictStr = Field(description="Phase in which error occurred")
    error_message: StrictStr = Field(description="Error message")
    __properties: ClassVar[List[str]] = ["phase", "error_message"]
