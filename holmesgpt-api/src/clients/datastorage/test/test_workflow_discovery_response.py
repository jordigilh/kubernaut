...
class TestWorkflowDiscoveryResponse(unittest.TestCase):
    """WorkflowDiscoveryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowDiscoveryResponse:
        """Test WorkflowDiscoveryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowDiscoveryResponse`
        """
        model = WorkflowDiscoveryResponse()
        if include_optional:
            return WorkflowDiscoveryResponse(
                action_type = '',
                workflows = [
                    datastorage.models.workflow_discovery_entry.WorkflowDiscoveryEntry(
                        workflow_id = '', 
                        workflow_name = '', 
                        name = '', 
                        description = '', 
    ...
    def testWorkflowDiscoveryResponse(self):
        """Test WorkflowDiscoveryResponse"""
