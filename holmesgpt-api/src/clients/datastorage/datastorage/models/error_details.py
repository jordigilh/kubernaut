...
class ErrorDetails(BaseModel):
    ...
    code: StrictStr = Field(description="Machine-readable error classification (ERR_[CATEGORY]_[SPECIFIC])")
    component: StrictStr = Field(description="Service emitting the error")
    retry_possible: StrictBool = Field(description="Whether the operation can be retried (true=transient, false=permanent)")
    stack_trace: Optional[List[StrictStr]] = Field(default=None, description="Top N stack frames for debugging (optional, 5-10 frames max)")
    __properties: ClassVar[List[str]] = ["message", "code", "component", "retry_possible", "stack_trace"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "retry_possible": obj.get("retry_possible"),
