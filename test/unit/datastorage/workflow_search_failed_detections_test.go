	...
	Describe("WorkflowSearchFilters", func() {
		Context("when DetectedLabels includes FailedDetections", func() {
			It("should include FailedDetections in search filters", func() {
				...
				Expect(filters.DetectedLabels).ToNot(BeNil())
				...
				// ASSERT: Other fields are still accessible
	...
	Describe("FailedDetections Validation", func() {
		Context("when validating field names", func() {
			...
			It("should validate field names using IsValidFailedDetectionField", func() {
				...
				Expect(models.IsValidFailedDetectionField(models.DetectedLabelGitOpsManaged)).To(BeTrue())
				Expect(models.IsValidFailedDetectionField(models.DetectedLabelPDBProtected)).To(BeTrue())
				Expect(models.IsValidFailedDetectionField(models.DetectedLabelHPAEnabled)).To(BeTrue())
