...
class TestActionTypeCatalogDisabledPayload(unittest.TestCase):
    """ActionTypeCatalogDisabledPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeCatalogDisabledPayload:
        """Test ActionTypeCatalogDisabledPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeCatalogDisabledPayload`
        """
        model = ActionTypeCatalogDisabledPayload()
        if include_optional:
            return ActionTypeCatalogDisabledPayload(
                event_type = 'datastorage.actiontype.disabled',
                action_type = '',
                disabled_by = '',
    ...
    def testActionTypeCatalogDisabledPayload(self):
        """Test ActionTypeCatalogDisabledPayload"""
