...
class TestRemediationRequestWebhookAuditPayload(unittest.TestCase):
    """RemediationRequestWebhookAuditPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationRequestWebhookAuditPayload:
        """Test RemediationRequestWebhookAuditPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationRequestWebhookAuditPayload`
        """
        model = RemediationRequestWebhookAuditPayload()
        if include_optional:
            return RemediationRequestWebhookAuditPayload(
    ...
    def testRemediationRequestWebhookAuditPayload(self):
        """Test RemediationRequestWebhookAuditPayload"""
