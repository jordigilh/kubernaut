...
show_usage_info() {
    ...
    echo "  • Setup Guide: docs/operations/deployment/HOLMESGPT_HYBRID_SETUP_GUIDE.md"
    echo "  • Architecture: docs/operations/deployment/HOLMESGPT_HYBRID_ARCHITECTURE.md"
    echo ""
