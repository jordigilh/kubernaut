...
class TestRemediationApprovalDecisionPayload(unittest.TestCase):
    """RemediationApprovalDecisionPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationApprovalDecisionPayload:
        """Test RemediationApprovalDecisionPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationApprovalDecisionPayload`
        """
        model = RemediationApprovalDecisionPayload()
        if include_optional:
            return RemediationApprovalDecisionPayload(
                ...
                decision_message = 'Root cause accurate. Safe to proceed with memory increase.',
                confidence = 0.75,
                workflow_id = 'oomkill-increase-memory-limits',
                workflow_version = 'v1.2.0',
                target_resource = 'payment/deployment/payment-api',
                timeout_deadline = '2026-01-15T10:45Z',
                decision_duration_seconds = 180,
    ...
    def testRemediationApprovalDecisionPayload(self):
        """Test RemediationApprovalDecisionPayload"""
