...
class TestWorkflowCatalogCreatedPayload(unittest.TestCase):
    """WorkflowCatalogCreatedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowCatalogCreatedPayload:
        """Test WorkflowCatalogCreatedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowCatalogCreatedPayload`
        """
        model = WorkflowCatalogCreatedPayload()
        if include_optional:
            return WorkflowCatalogCreatedPayload(
    ...
    def testWorkflowCatalogCreatedPayload(self):
        """Test WorkflowCatalogCreatedPayload"""
