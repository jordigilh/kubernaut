...
class TestValidationAttempt(unittest.TestCase):
    """ValidationAttempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationAttempt:
        """Test ValidationAttempt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationAttempt`
        """
    ...
    def testValidationAttempt(self):
        """Test ValidationAttempt"""
