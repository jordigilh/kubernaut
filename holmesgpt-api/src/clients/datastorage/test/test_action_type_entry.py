...
class TestActionTypeEntry(unittest.TestCase):
    """ActionTypeEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeEntry:
        """Test ActionTypeEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeEntry`
        """
        model = ActionTypeEntry()
        if include_optional:
