...
class TestEffectivenessComponents(unittest.TestCase):
    """EffectivenessComponents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectivenessComponents:
        """Test EffectivenessComponents
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectivenessComponents`
        """
        model = EffectivenessComponents()
        if include_optional:
            return EffectivenessComponents(
    ...
    def testEffectivenessComponents(self):
        """Test EffectivenessComponents"""
