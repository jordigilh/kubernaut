...
var _ = Describe("kubernaut_get_remediation_history", func() {
	...
	// UT-AF-1773-001..006 (BR-AI + SI-10): port of main's #1462 fix coverage.
	// #1773 is a regression of #1462: currentSpecHash is again missing end
	// to end (args struct, DS client opts, ogen wire params).

	It("UT-AF-1773-001: empty kind returns validation error", func() {
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
	...
	It("UT-AF-1773-002: empty name returns validation error", func() {
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
	...
	It("UT-AF-1773-003: empty spec_hash returns validation error", func() {
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
	...
	It("UT-AF-1773-004: all params valid passes spec_hash to DS client", func() {
	...
	It("UT-AF-1773-005: empty namespace is allowed for cluster-scoped resources", func() {
		var capturedOpts ds.HistoryOpts
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
				capturedOpts = opts
	...
	It("UT-AF-1773-006: since parameter passes through correctly", func() {
		var capturedOpts ds.HistoryOpts
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
				capturedOpts = opts
	...
	It("UT-AF-1773-E01: spec_hash without sha256: prefix returns format error", func() {
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
	...
	It("UT-AF-1773-E02: spec_hash with valid sha256: prefix passes validation", func() {
		mock := &ds.MockClient{
			GetRemediationHistoryFn: func(ctx context.Context, opts ds.HistoryOpts) ([]ds.HistoricalRemediation, error) {
				return []ds.HistoricalRemediation{{ID: "rr-1"}}, nil
			},
