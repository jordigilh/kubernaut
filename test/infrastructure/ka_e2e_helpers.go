...
func GetKAE2ETestWorkflows() []TestWorkflow {
	...
	baseWorkflows := []TestWorkflow{
		{WorkflowID: "oomkill-increase-memory-v1", Name: "OOMKill Remediation - Increase Memory Limits", Description: "Increases memory limits for pods experiencing OOMKilled events", ActionType: "IncreaseMemoryLimits", Severity: "critical", Component: []string{"*"}, Priority: "*", SchemaImage: kaWorkflowRegistry + "/oomkill-increase-memory:v1.0.0",
		...
		{WorkflowID: "crashloop-config-fix-v1", Name: "CrashLoopBackOff - Fix Configuration", Description: "Identifies and fixes configuration issues causing CrashLoopBackOff", ActionType: "RestartDeployment", Severity: "high", Component: []string{"apps/v1/Deployment"}, Priority: "P1", SchemaImage: kaWorkflowRegistry + "/crashloop-config-fix:v1.0.0",
			SchemaParameters: []models.WorkflowParameter{
				{Name: "NAMESPACE", Type: "string", Required: true, Description: "Target namespace"},
		...
		{WorkflowID: "node-drain-reboot-v1", Name: "NodeNotReady - Drain and Reboot", Description: "Safely drains and reboots nodes in NotReady state", ActionType: "DrainNode", Severity: "critical", Component: []string{"v1/Node"}, Priority: "P0", SchemaImage: kaWorkflowRegistry + "/node-drain-reboot:v1.0.0",
			SchemaParameters: []models.WorkflowParameter{
		...
		{WorkflowID: "generic-restart-v1", Name: "Generic Pod Restart", Description: "Generic pod restart for unknown issues", ActionType: "RestartPod", Severity: "warning", Component: []string{"v1/Pod"}, Priority: "P2", SchemaImage: kaWorkflowRegistry + "/generic-restart:v1.0.0",
			SchemaParameters: []models.WorkflowParameter{
				{Name: "NAMESPACE", Type: "string", Required: true, Description: "Target namespace"},
		...
		{WorkflowID: "ambiguous-kind-fix-v1", Name: "Ambiguous Kind Fix - TestWidget", Description: "Reconfigures a TestWidget CR when the kind is ambiguous across API groups", ActionType: "ReconfigureResource", Severity: "high", Component: []string{"*"}, Priority: "P1", ExecutionEngine: "job", SchemaImage: kaWorkflowRegistry + "/ambiguous-kind-fix:v1.0.0",
			SchemaParameters: []models.WorkflowParameter{
