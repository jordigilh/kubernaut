...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DBDetectedLabels) DeepCopyInto(out *DBDetectedLabels) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DBDetectedLabels.
func (in *DBDetectedLabels) DeepCopy() *DBDetectedLabels {
	if in == nil {
		return nil
	}
	out := new(DBDetectedLabels)
	in.DeepCopyInto(out)
	return out
}
