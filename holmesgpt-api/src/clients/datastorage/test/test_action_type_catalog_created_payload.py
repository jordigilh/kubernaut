...
class TestActionTypeCatalogCreatedPayload(unittest.TestCase):
    """ActionTypeCatalogCreatedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeCatalogCreatedPayload:
        """Test ActionTypeCatalogCreatedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeCatalogCreatedPayload`
        """
        model = ActionTypeCatalogCreatedPayload()
        if include_optional:
            return ActionTypeCatalogCreatedPayload(
                event_type = 'datastorage.actiontype.created',
                action_type = '',
    ...
    def testActionTypeCatalogCreatedPayload(self):
        """Test ActionTypeCatalogCreatedPayload"""
