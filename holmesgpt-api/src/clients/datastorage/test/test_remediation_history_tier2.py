...
class TestRemediationHistoryTier2(unittest.TestCase):
    """RemediationHistoryTier2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationHistoryTier2:
        """Test RemediationHistoryTier2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationHistoryTier2`
        """
        model = RemediationHistoryTier2()
        if include_optional:
            return RemediationHistoryTier2(
                window = '2160h',
                chain = [
    ...
    def testRemediationHistoryTier2(self):
        """Test RemediationHistoryTier2"""
