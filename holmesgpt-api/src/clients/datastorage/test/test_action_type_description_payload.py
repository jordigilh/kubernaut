...
class TestActionTypeDescriptionPayload(unittest.TestCase):
    """ActionTypeDescriptionPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionTypeDescriptionPayload:
        """Test ActionTypeDescriptionPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionTypeDescriptionPayload`
        """
        model = ActionTypeDescriptionPayload()
        if include_optional:
            return ActionTypeDescriptionPayload(
                what = '',
                when_to_use = '',
                when_not_to_use = '',
                preconditions = ''
    ...
    def testActionTypeDescriptionPayload(self):
        """Test ActionTypeDescriptionPayload"""
