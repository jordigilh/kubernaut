...
func (in *LLMConfig) DeepCopyInto(out *LLMConfig) {
	*out = *in
	...
	if in.PhaseModels != nil {
		...
		*out = make(map[string]*LLMOverride, len(*in))
		for key, val := range *in {
			var outVal *LLMOverride
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMOverride) DeepCopyInto(out *LLMOverride) {
	*out = *in
	if in.Reasoning != nil {
		in, out := &in.Reasoning, &out.Reasoning
		*out = new(LLMReasoningConfig)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMOverride.
func (in *LLMOverride) DeepCopy() *LLMOverride {
	if in == nil {
		return nil
	}
	out := new(LLMOverride)
