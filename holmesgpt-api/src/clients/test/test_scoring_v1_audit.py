...
class TestScoringV1Audit(unittest.TestCase):
    """ScoringV1Audit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScoringV1Audit:
        """Test ScoringV1Audit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScoringV1Audit`
        """
        model = ScoringV1Audit()
        if include_optional:
            return ScoringV1Audit(
                confidence = 0.95
            )
        else:
            return ScoringV1Audit(
