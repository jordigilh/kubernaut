...
class TestRemediationHistoryContext(unittest.TestCase):
    """RemediationHistoryContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationHistoryContext:
        """Test RemediationHistoryContext
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationHistoryContext`
        """
        model = RemediationHistoryContext()
        if include_optional:
            return RemediationHistoryContext(
                target_resource = 'prod/Deployment/my-app',
                current_spec_hash = 'sha256:aabb112233dd',
                regression_detected = True,
                tier1 = datastorage.models.remediation_history_tier1.RemediationHistoryTier1(
                    window = '24h', 
                    chain = [
                        datastorage.models.remediation_history_entry.RemediationHistoryEntry(
                            ...
                            hash_match = 'postRemediation', 
                            pre_remediation_spec_hash = 'sha256:aabb112233dd', 
                            post_remediation_spec_hash = 'sha256:ccdd334455ee', 
                            health_checks = datastorage.models.remediation_health_checks.RemediationHealthChecks(
                                pod_running = True, 
                                readiness_pass = True, 
                                restart_delta = 0, 
                                crash_loops = False, 
                                oom_killed = False, 
                                pending_count = 0, ), 
                            metric_deltas = datastorage.models.remediation_metric_deltas.RemediationMetricDeltas(
                                cpu_before = 0.95, 
                                cpu_after = 0.92, 
                                memory_before = 0.6, 
                                memory_after = 0.62, 
                            ...
                            side_effects = [], 
                            completed_at = '2026-02-05T08:00Z', 
                            assessment_reason = 'full', 
                            assessed_at = '2026-02-05T08:05Z', )
                        ], ),
                tier2 = datastorage.models.remediation_history_tier2.RemediationHistoryTier2(
                    window = '2160h', 
                    chain = [
                        datastorage.models.remediation_history_summary.RemediationHistorySummary(
                            ...
                            effectiveness_score = 0.4, 
                            signal_resolved = False, 
                            hash_match = 'preRemediation', 
                            assessment_reason = 'full', 
                            completed_at = '2026-01-15T10:00Z', )
                        ], )
            )
        else:
            return RemediationHistoryContext(
    ...
    def testRemediationHistoryContext(self):
        """Test RemediationHistoryContext"""
