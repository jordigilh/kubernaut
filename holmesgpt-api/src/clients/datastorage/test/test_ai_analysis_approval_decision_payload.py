...
class TestAIAnalysisApprovalDecisionPayload(unittest.TestCase):
    """AIAnalysisApprovalDecisionPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAnalysisApprovalDecisionPayload:
        """Test AIAnalysisApprovalDecisionPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAnalysisApprovalDecisionPayload`
        """
        model = AIAnalysisApprovalDecisionPayload()
        if include_optional:
            return AIAnalysisApprovalDecisionPayload(
                approval_required = True,
                approval_reason = 'Production environment requires manual approval',
                auto_approved = False,
                decision = 'requires_approval',
                reason = 'Rego policy requires manual approval for production',
                environment = 'production',
                confidence = 0.95,
                workflow_id = 'restart-oomkilled-pod'
            )
        else:
            return AIAnalysisApprovalDecisionPayload(
                approval_required = True,
    ...
    def testAIAnalysisApprovalDecisionPayload(self):
        """Test AIAnalysisApprovalDecisionPayload"""
