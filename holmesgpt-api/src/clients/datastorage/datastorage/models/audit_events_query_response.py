...
class AuditEventsQueryResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [AuditEvent.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "pagination": AuditEventsQueryResponsePagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None
        })
        return _obj
