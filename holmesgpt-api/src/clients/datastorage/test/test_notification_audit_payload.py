...
class TestNotificationAuditPayload(unittest.TestCase):
    """NotificationAuditPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationAuditPayload:
        """Test NotificationAuditPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationAuditPayload`
        """
    ...
    def testNotificationAuditPayload(self):
        """Test NotificationAuditPayload"""
