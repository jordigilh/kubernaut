...
class ActionTypeCatalogReenabledPayload(BaseModel):
    """
    DS audit payload when a previously disabled action type is re-enabled
    """ # noqa: E501
    event_type: StrictStr
    action_type: StrictStr
    reenabled_by: StrictStr
    previous_state: StrictStr
    disabled_at: datetime
    disabled_by: StrictStr
    __properties: ClassVar[List[str]] = ["event_type", "action_type", "reenabled_by", "previous_state", "disabled_at", "disabled_by"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('datastorage.actiontype.reenabled'):
            raise ValueError("must be one of enum values ('datastorage.actiontype.reenabled')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "reenabled_by": obj.get("reenabled_by"),
