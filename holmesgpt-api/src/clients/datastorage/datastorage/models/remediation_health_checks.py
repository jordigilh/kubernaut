...
class RemediationHealthChecks(BaseModel):
    """
    Post-remediation health check results from EM assessment. 
    """ # noqa: E501
    pod_running: Optional[StrictBool] = Field(default=None, description="Whether the target pod is running", alias="podRunning")
    readiness_pass: Optional[StrictBool] = Field(default=None, description="Whether readiness probes are passing", alias="readinessPass")
    restart_delta: Optional[StrictInt] = Field(default=None, description="Change in restart count since remediation", alias="restartDelta")
    crash_loops: Optional[StrictBool] = Field(default=None, description="Whether crash loops were detected", alias="crashLoops")
    oom_killed: Optional[StrictBool] = Field(default=None, description="Whether OOM kills were detected", alias="oomKilled")
    pending_count: Optional[StrictInt] = Field(default=None, description="Number of pods still in Pending phase after the stabilization window. Non-zero indicates scheduling failures, image pull issues, or resource exhaustion. ", alias="pendingCount")
    __properties: ClassVar[List[str]] = ["podRunning", "readinessPass", "restartDelta", "crashLoops", "oomKilled", "pendingCount"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "podRunning": obj.get("podRunning"),
            "readinessPass": obj.get("readinessPass"),
            "restartDelta": obj.get("restartDelta"),
            "crashLoops": obj.get("crashLoops"),
