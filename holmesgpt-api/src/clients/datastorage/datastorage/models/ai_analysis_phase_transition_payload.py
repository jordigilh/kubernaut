...
class AIAnalysisPhaseTransitionPayload(BaseModel):
    """
    Phase transition event payload (aianalysis.phase.transition)
    """ # noqa: E501
    old_phase: StrictStr = Field(description="Previous phase")
    new_phase: StrictStr = Field(description="New phase")
    __properties: ClassVar[List[str]] = ["old_phase", "new_phase"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "old_phase": obj.get("old_phase"),
            "new_phase": obj.get("new_phase")
        })
        return _obj
