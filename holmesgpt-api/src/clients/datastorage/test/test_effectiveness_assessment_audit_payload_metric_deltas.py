...
class TestEffectivenessAssessmentAuditPayloadMetricDeltas(unittest.TestCase):
    """EffectivenessAssessmentAuditPayloadMetricDeltas unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectivenessAssessmentAuditPayloadMetricDeltas:
        """Test EffectivenessAssessmentAuditPayloadMetricDeltas
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectivenessAssessmentAuditPayloadMetricDeltas`
        """
        model = EffectivenessAssessmentAuditPayloadMetricDeltas()
        if include_optional:
    ...
    def testEffectivenessAssessmentAuditPayloadMetricDeltas(self):
        """Test EffectivenessAssessmentAuditPayloadMetricDeltas"""
