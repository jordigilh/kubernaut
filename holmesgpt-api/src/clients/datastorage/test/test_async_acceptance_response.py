...
class TestAsyncAcceptanceResponse(unittest.TestCase):
    """AsyncAcceptanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsyncAcceptanceResponse:
        """Test AsyncAcceptanceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsyncAcceptanceResponse`
        """
        model = AsyncAcceptanceResponse()
        if include_optional:
            return AsyncAcceptanceResponse(
                status = 'accepted',
    ...
    def testAsyncAcceptanceResponse(self):
        """Test AsyncAcceptanceResponse"""
