...
class TestIncidentListResponse(unittest.TestCase):
    """IncidentListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentListResponse:
        """Test IncidentListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentListResponse`
        """
        model = IncidentListResponse()
        if include_optional:
            return IncidentListResponse(
                data = [
                    datastorage.models.incident.Incident(
                        id = 12345, 
                ...
                pagination = datastorage.models.pagination.Pagination(
                    total = 1523, 
                    limit = 100, 
                    offset = 0, 
                    has_more = True, )
    ...
    def testIncidentListResponse(self):
        """Test IncidentListResponse"""
