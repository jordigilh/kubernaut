...
class TestIncidentResponseDataSelectedWorkflow(unittest.TestCase):
    """IncidentResponseDataSelectedWorkflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentResponseDataSelectedWorkflow:
        """Test IncidentResponseDataSelectedWorkflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentResponseDataSelectedWorkflow`
        """
        model = IncidentResponseDataSelectedWorkflow()
        if include_optional:
    ...
    def testIncidentResponseDataSelectedWorkflow(self):
        """Test IncidentResponseDataSelectedWorkflow"""
