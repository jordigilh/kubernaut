...
class HashComparisonData(BaseModel):
    """
    Pre/post remediation spec hash comparison data per DD-EM-002. Supplementary signal (not part of scoring formula). 
    """ # noqa: E501
    pre_remediation_spec_hash: Optional[StrictStr] = Field(default=None, description="Canonical SHA-256 hash of target resource spec before remediation.")
    post_remediation_spec_hash: Optional[StrictStr] = Field(default=None, description="Canonical SHA-256 hash of target resource spec after remediation.")
    hash_match: Optional[StrictBool] = Field(default=None, description="Whether pre and post hashes match (true = no spec change detected).")
    __properties: ClassVar[List[str]] = ["pre_remediation_spec_hash", "post_remediation_spec_hash", "hash_match"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if hash_match (nullable) is None
        # and model_fields_set contains the field
        if self.hash_match is None and "hash_match" in self.model_fields_set:
            _dict['hash_match'] = None
