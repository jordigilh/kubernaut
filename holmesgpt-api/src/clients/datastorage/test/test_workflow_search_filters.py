...
class TestWorkflowSearchFilters(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkflowSearchFilters:
        """Test WorkflowSearchFilters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowSearchFilters`
        """
    ...
    def testWorkflowSearchFilters(self):
        """Test WorkflowSearchFilters"""
