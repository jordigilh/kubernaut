...
class TestLLMRequestPayload(unittest.TestCase):
    """LLMRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LLMRequestPayload:
        """Test LLMRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LLMRequestPayload`
        """
    ...
    def testLLMRequestPayload(self):
        """Test LLMRequestPayload"""
