...
// ========================================
// IN-MEMORY GO FILTER/SCORING PREDICATES (Issue #1677 Phase 2b)
// ========================================
// Authority: DD-WORKFLOW-019 (KA owns discovery directly). Ported verbatim
// from pkg/datastorage/repository/workflow/cache_filter.go (Issue #1661
// Change 6) -- these predicates back Catalog.ListActions/
// ListWorkflowsByActionType/List.
//
...
// dimensions (Phase 2b: List's cache port). Mirrors applyListFilters' SQL
// WHERE-clause combination exactly: workflow_name exact match, severity/
// component/environment/priority wildcard label matching (Issue #522
// parity with the discovery path, reusing matchesArrayLabel/
// matchesPriority), and status containment. Unlike
