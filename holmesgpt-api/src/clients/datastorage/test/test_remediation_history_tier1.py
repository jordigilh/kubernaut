...
class TestRemediationHistoryTier1(unittest.TestCase):
    """RemediationHistoryTier1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationHistoryTier1:
        """Test RemediationHistoryTier1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationHistoryTier1`
        """
        model = RemediationHistoryTier1()
        if include_optional:
            return RemediationHistoryTier1(
                window = '24h',
                chain = [
    ...
    def testRemediationHistoryTier1(self):
        """Test RemediationHistoryTier1"""
