...
class TestIncidentResponseDataAlternativeWorkflowsInner(unittest.TestCase):
    """IncidentResponseDataAlternativeWorkflowsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentResponseDataAlternativeWorkflowsInner:
        """Test IncidentResponseDataAlternativeWorkflowsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentResponseDataAlternativeWorkflowsInner`
        """
        model = IncidentResponseDataAlternativeWorkflowsInner()
        if include_optional:
            return IncidentResponseDataAlternativeWorkflowsInner(
                workflow_id = '',
                rationale = ''
            )
        else:
    ...
    def testIncidentResponseDataAlternativeWorkflowsInner(self):
        """Test IncidentResponseDataAlternativeWorkflowsInner"""
