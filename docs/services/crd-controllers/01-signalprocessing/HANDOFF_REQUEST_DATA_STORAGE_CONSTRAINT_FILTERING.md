...
**Current understanding** (DD-WORKFLOW-001 v1.8): 5 mandatory labels are:
1. `signal_type`
2. `severity`
3. `component`
4. `environment`
...
| [DD-WORKFLOW-001 v1.8](../../../architecture/decisions/DD-WORKFLOW-001-mandatory-label-schema.md) | 5 mandatory labels + DetectedLabels + CustomLabels (snake_case API fields) |
