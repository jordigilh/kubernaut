...
| Builder base | `registry.access.redhat.com/ubi10/go-toolset:1.26` (GOTOOLCHAIN=auto upgrades to go.mod version) |
...
- [x] Go toolset pinned to minor (`go-toolset:1.26`, GOTOOLCHAIN=auto)
