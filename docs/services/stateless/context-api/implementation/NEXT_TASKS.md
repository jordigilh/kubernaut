...
**Implementation Plan**: [IMPLEMENTATION_PLAN_V2.7.md](IMPLEMENTATION_PLAN_V2.7.md) (now v2.2.1)
...
**Critical Issue**: Batch activation approach violated TDD principles (see [v2.1 changelog](IMPLEMENTATION_PLAN_V2.7.md))
