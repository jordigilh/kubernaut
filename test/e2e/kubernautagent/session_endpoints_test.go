...
var _ = Describe("E2E-KA-064: Session-Based Endpoints", Label("e2e", "ka", "session", "aa-064"), func() {

	// sessionClient is initialized in SynchronizedBeforeSuite (suite_test.go)
	// It provides async submit/poll/result methods for session-based KA endpoints.
	...
	Context("Incident Session: Happy path scenarios", func() {
		...
		It("E2E-KA-064-001: Incident submit/poll/result for CrashLoopBackOff", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
		...
		It("E2E-KA-064-002: Incident submit/poll/result for OOMKilled", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
	...
	Context("Incident Session: Human review scenarios", func() {
		...
		It("E2E-KA-064-003: No workflow found via session", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
			...
			Expect(result.HumanReviewReason.Value).To(Equal(agentclient.HumanReviewReasonNoMatchingWorkflows),
		...
		It("E2E-KA-064-004: Low confidence via session", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
		...
		It("E2E-KA-064-005: Max retries exhausted via session", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
			...
			Expect(result.HumanReviewReason.Value).To(Equal(agentclient.HumanReviewReasonLlmParsingError),
	...
	Context("Incident Session: Status transitions", func() {
		...
		It("E2E-KA-064-006: Session status transitions observable during investigation", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
	...
	Context("Session Error Handling", func() {
		...
		It("E2E-KA-064-011: Poll non-existent session returns error", func() {
			// ========================================
			// TEST PLAN MAPPING
			// ========================================
