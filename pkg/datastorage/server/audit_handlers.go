...
// writeValidationRFC7807Error writes validation.RFC7807Problem directly to preserve Extensions
// The validation package's RFC7807Problem includes Extensions that must be flattened into JSON
