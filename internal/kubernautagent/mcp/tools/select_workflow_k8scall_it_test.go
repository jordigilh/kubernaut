...
func (k8sCallStubDSClient) GetRemediationHistory(_ context.Context, _, _, _, _, _ string) (*enrichment.RemediationHistoryResult, error) {
...
var _ = Describe("IT-KA-898-K8SCALL: Real enrichment.Enricher wired through select_workflow (BR-INTERACTIVE-003 #3, audit catalog gap follow-up)", func() {
	...
	// (cmd/kubernautagent/routes.go). These IT tests wire the real Enricher
