...
audit_export_response_hash_chain_verification_form_dict = audit_export_response_hash_chain_verification.from_dict(audit_export_response_hash_chain_verification_dict)
```
