...
class TestAIAnalysisErrorPayload(unittest.TestCase):
    """AIAnalysisErrorPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAnalysisErrorPayload:
        """Test AIAnalysisErrorPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAnalysisErrorPayload`
        """
        model = AIAnalysisErrorPayload()
        if include_optional:
            return AIAnalysisErrorPayload(
                phase = 'Investigating',
    ...
    def testAIAnalysisErrorPayload(self):
        """Test AIAnalysisErrorPayload"""
