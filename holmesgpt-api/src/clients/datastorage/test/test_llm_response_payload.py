...
class TestLLMResponsePayload(unittest.TestCase):
    """LLMResponsePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LLMResponsePayload:
        """Test LLMResponsePayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LLMResponsePayload`
        """
    ...
    def testLLMResponsePayload(self):
        """Test LLMResponsePayload"""
