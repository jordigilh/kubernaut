...
class ActionTypeTaxonomyAPIApi:
    ...
    @validate_call
    def get_action_type_workflow_count(
        self,
        name: Annotated[StrictStr, Field(description="PascalCase action type name (e.g., RestartPod)")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_action_type_workflow_count_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ActionTypeWorkflowCountResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_action_type_workflow_count_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="PascalCase action type name (e.g., RestartPod)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActionTypeWorkflowCountResponse]:
        """Get active workflow count for an action type
    ...
    @validate_call
    def get_action_type_workflow_count_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="PascalCase action type name (e.g., RestartPod)")],
        _request_timeout: Union[
            None,
    ...
    def _get_action_type_workflow_count_serialize(
        self,
        name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/action-types/{name}/workflow-count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
