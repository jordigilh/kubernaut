...
class AsyncAcceptanceResponse(BaseModel):
    """
    Response when audit event is queued for async processing (202 Accepted)
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the async operation")
    message: StrictStr = Field(description="Explanation of the async processing")
