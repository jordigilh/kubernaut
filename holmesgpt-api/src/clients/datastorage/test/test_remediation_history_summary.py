...
class TestRemediationHistorySummary(unittest.TestCase):
    """RemediationHistorySummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationHistorySummary:
        """Test RemediationHistorySummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationHistorySummary`
        """
        model = RemediationHistorySummary()
        if include_optional:
    ...
    def testRemediationHistorySummary(self):
        """Test RemediationHistorySummary"""
