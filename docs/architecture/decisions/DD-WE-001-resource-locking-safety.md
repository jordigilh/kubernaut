...
- **WE Role**: Pure executor - executes WFE CRDs created by RO
- **RO Role**: Router - checks resource locks before creating WFE CRDs

**This document remains for historical context and understanding the original design rationale.**
