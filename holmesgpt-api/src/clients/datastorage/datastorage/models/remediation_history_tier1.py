...
class RemediationHistoryTier1(BaseModel):
    """
    ...
    """ # noqa: E501
    window: StrictStr = Field(description="Lookback window used for this tier (e.g. \"24h\")")
    chain: List[RemediationHistoryEntry] = Field(description="Ordered list of detailed remediation entries (ascending by completedAt)")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "chain": [RemediationHistoryEntry.from_dict(_item) for _item in obj.get("chain")] if obj.get("chain") is not None else None
        })
        return _obj
