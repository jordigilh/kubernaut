...
**Note**: HolmesGPT API implementation details (prompts, Claude integration) are documented in `docs/services/kubernaut-agent/` and will be reviewed with AIAnalysis service implementation.
