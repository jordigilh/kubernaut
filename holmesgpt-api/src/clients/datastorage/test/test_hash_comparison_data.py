...
class TestHashComparisonData(unittest.TestCase):
    """HashComparisonData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HashComparisonData:
        """Test HashComparisonData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HashComparisonData`
        """
        model = HashComparisonData()
        if include_optional:
            return HashComparisonData(
    ...
    def testHashComparisonData(self):
        """Test HashComparisonData"""
