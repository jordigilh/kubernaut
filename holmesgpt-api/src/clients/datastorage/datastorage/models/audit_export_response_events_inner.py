...
class AuditExportResponseEventsInner(BaseModel):
    """
    ...
    event_outcome: Optional[StrictStr] = None
    correlation_id: Optional[StrictStr] = None
    event_data: Optional[Dict[str, Any]] = None
    event_hash: Optional[StrictStr] = Field(default=None, description="SHA256 hash of this event")
    previous_event_hash: Optional[StrictStr] = Field(default=None, description="Hash of previous event in chain")
    hash_chain_valid: Optional[StrictBool] = Field(default=None, description="Whether this event's hash chain is valid")
    legal_hold: Optional[StrictBool] = Field(default=None, description="Whether this event is under legal hold")
    __properties: ClassVar[List[str]] = ["event_id", "version", "event_type", "event_timestamp", "event_category", "event_action", "event_outcome", "correlation_id", "event_data", "event_hash", "previous_event_hash", "hash_chain_valid", "legal_hold"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "previous_event_hash": obj.get("previous_event_hash"),
            "hash_chain_valid": obj.get("hash_chain_valid"),
