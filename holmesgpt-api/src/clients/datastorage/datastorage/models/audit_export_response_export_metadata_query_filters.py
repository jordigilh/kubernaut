...
class AuditExportResponseExportMetadataQueryFilters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["start_time", "end_time", "correlation_id", "event_category", "offset", "limit"]
