...
class TestWorkflowSearchResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkflowSearchResult:
        """Test WorkflowSearchResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowSearchResult`
        """
        model = WorkflowSearchResult()
        if include_optional:
    ...
    def testWorkflowSearchResult(self):
        """Test WorkflowSearchResult"""
