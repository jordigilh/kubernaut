...
class AIAnalysisApprovalDecisionPayload(BaseModel):
    """
    ...
    approval_reason: StrictStr = Field(description="Reason for approval requirement")
    auto_approved: StrictBool = Field(description="Whether auto-approved")
    decision: StrictStr = Field(description="Decision made")
    reason: StrictStr = Field(description="Reason for decision")
    environment: StrictStr = Field(description="Environment context")
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Workflow confidence level (optional)")
    workflow_id: Optional[StrictStr] = Field(default=None, description="Selected workflow identifier (optional)")
    __properties: ClassVar[List[str]] = ["approval_required", "approval_reason", "auto_approved", "decision", "reason", "environment", "confidence", "workflow_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "auto_approved": obj.get("auto_approved"),
