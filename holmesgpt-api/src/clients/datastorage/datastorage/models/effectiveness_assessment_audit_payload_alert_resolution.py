...
class EffectivenessAssessmentAuditPayloadAlertResolution(BaseModel):
    """
    Structured alert resolution check results from AlertManager. Only present for effectiveness.alert.assessed events. 
    """ # noqa: E501
    alert_resolved: Optional[StrictBool] = Field(default=None, description="Whether the triggering alert is no longer active in AlertManager")
    active_count: Optional[StrictInt] = Field(default=None, description="Number of matching active alerts found in AlertManager")
    resolution_time_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Seconds from remediation completion to alert resolution (null if not resolved)")
    __properties: ClassVar[List[str]] = ["alert_resolved", "active_count", "resolution_time_seconds"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "alert_resolved": obj.get("alert_resolved"),
