...
from datastorage.models.incident_type_success_rate_response import IncidentTypeSuccessRateResponse

class TestIncidentTypeSuccessRateResponse(unittest.TestCase):
    """IncidentTypeSuccessRateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentTypeSuccessRateResponse:
        """Test IncidentTypeSuccessRateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentTypeSuccessRateResponse`
        """
        model = IncidentTypeSuccessRateResponse()
        if include_optional:
            return IncidentTypeSuccessRateResponse(
                ...
                ai_execution_mode = datastorage.models.ai_execution_mode_stats.AIExecutionModeStats(
                    ...
                    manual_escalation = 3, ),
                workflow_breakdown = [
                    datastorage.models.workflow_breakdown_item.WorkflowBreakdownItem(
    ...
    def testIncidentTypeSuccessRateResponse(self):
        """Test IncidentTypeSuccessRateResponse"""
