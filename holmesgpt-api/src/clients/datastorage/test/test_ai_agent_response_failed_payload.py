...
class TestAIAgentResponseFailedPayload(unittest.TestCase):
    """AIAgentResponseFailedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAgentResponseFailedPayload:
        """Test AIAgentResponseFailedPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAgentResponseFailedPayload`
        """
        model = AIAgentResponseFailedPayload()
        if include_optional:
            return AIAgentResponseFailedPayload(
                event_type = 'aiagent.response.failed',
                event_id = 'evt-hapi-fail-123-abc',
    ...
    def testAIAgentResponseFailedPayload(self):
        """Test AIAgentResponseFailedPayload"""
