...
type Config struct {
	...
	// When enabled, RO uses FederatedScopeChecker backed by Valkey for remote scope checks.
	Fleet FleetConfig `yaml:"fleet,omitempty"`
}

// FleetConfig holds multi-cluster federation settings for the RO (ADR-065).
