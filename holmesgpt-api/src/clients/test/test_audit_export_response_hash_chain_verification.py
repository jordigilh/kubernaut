...
class TestAuditExportResponseHashChainVerification(unittest.TestCase):
    """AuditExportResponseHashChainVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditExportResponseHashChainVerification:
        """Test AuditExportResponseHashChainVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditExportResponseHashChainVerification`
        """
        model = AuditExportResponseHashChainVerification()
        if include_optional:
            return AuditExportResponseHashChainVerification(
    ...
    def testAuditExportResponseHashChainVerification(self):
        """Test AuditExportResponseHashChainVerification"""
