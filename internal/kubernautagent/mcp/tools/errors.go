...
var (
	...
	// (#2100, v1.6 clone #2101). Before this fix, this case fell through to
	// a silent "started" response with an empty InvestigationSessionID --
	// the client held a Lease (eroding interactive.maxConcurrentSessions
