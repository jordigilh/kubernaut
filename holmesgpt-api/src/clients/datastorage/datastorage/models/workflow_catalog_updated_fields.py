...
class WorkflowCatalogUpdatedFields(BaseModel):
    """
    Fields that were updated in the workflow catalog
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Updated workflow status")
    disabled_by: Optional[StrictStr] = Field(default=None, description="User who disabled the workflow (only for status=disabled)")
    disabled_reason: Optional[StrictStr] = Field(default=None, description="Reason for disabling (only for status=disabled)")
    version: Optional[StrictStr] = Field(default=None, description="Updated version")
    description: Optional[StrictStr] = Field(default=None, description="Updated description")
    __properties: ClassVar[List[str]] = ["status", "disabled_by", "disabled_reason", "version", "description"]
