...
class ScoringV1Audit(BaseModel):
    """
    V1.0 scoring (confidence only per DD-WORKFLOW-004 v2.0)
    """ # noqa: E501
    confidence: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="Overall confidence score (0.0-1.0)")
