...
class TestEffectivenessScoreResponse(unittest.TestCase):
    """EffectivenessScoreResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectivenessScoreResponse:
        """Test EffectivenessScoreResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectivenessScoreResponse`
        """
        model = EffectivenessScoreResponse()
        if include_optional:
            return EffectivenessScoreResponse(
                correlation_id = 'rr-prometheus-alert-highcpu-abc123',
                score = 0.91,
                components = datastorage.models.effectiveness_components.EffectivenessComponents(
                    ...
                    alert_score = 1.337, 
                    alert_details = '', 
                    metrics_assessed = True, 
                    metrics_score = 1.337, 
                    metrics_details = '', ),
                hash_comparison = datastorage.models.hash_comparison_data.HashComparisonData(
                    pre_remediation_spec_hash = 'sha256:abc123...', 
                    post_remediation_spec_hash = 'sha256:def456...', 
                    hash_match = True, ),
    ...
    def testEffectivenessScoreResponse(self):
        """Test EffectivenessScoreResponse"""
