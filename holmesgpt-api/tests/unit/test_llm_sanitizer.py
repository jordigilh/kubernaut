...
class TestTokenPatterns:
    ...
    def test_bearer_token_sanitized(self):
        ...
        input_str = "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
        result = sanitize_for_llm(input_str)
    ...
    def test_github_token_sanitized(self):
        ...
        input_str = "GITHUB_TOKEN=ghp_abcdefghijklmnopqrstuvwxyz1234567890"
        result = sanitize_for_llm(input_str)
    ...
    def test_github_oauth_token_sanitized(self):
        ...
        input_str = "token: gho_abcdefghijklmnopqrstuvwxyz1234567890"
        result = sanitize_for_llm(input_str)
        assert "gho_abcdefghijklmnopqrstuvwxyz1234567890" not in result
