...
class TestAuditExportResponse(unittest.TestCase):
    """AuditExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditExportResponse:
        """Test AuditExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditExportResponse`
        """
        model = AuditExportResponse()
        if include_optional:
            return AuditExportResponse(
                export_metadata = datastorage.models.audit_export_response_export_metadata.AuditExportResponse_export_metadata(
                    export_timestamp = '2026-01-07T20:30Z', 
                    export_format = 'json', 
                    query_filters = datastorage.models.audit_export_response_export_metadata_query_filters.AuditExportResponse_export_metadata_query_filters(
                    ...
                    certificate_fingerprint = '3a:f7:12:9c:...', 
                    exported_by = 'system:serviceaccount:kubernaut-system:auditor', ),
                events = [
                    datastorage.models.audit_export_response_events_inner.AuditExportResponse_events_inner(
                        event_id = '', 
                        version = '', 
                        event_type = '', 
                ...
                hash_chain_verification = datastorage.models.audit_export_response_hash_chain_verification.AuditExportResponse_hash_chain_verification(
                ...
                detached_signature = '-----BEGIN SIGNATURE-----
...'
            )
        else:
            return AuditExportResponse(
    ...
    def testAuditExportResponse(self):
        """Test AuditExportResponse"""
