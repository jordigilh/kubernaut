...
class NotificationAuditPayloadRecipientsInner(BaseModel):
    """
    Notification recipient (matches CRD Recipient struct)
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Email address (for email channel)")
    slack: Optional[StrictStr] = Field(default=None, description="Slack channel or user (#channel-name or @username)")
    teams: Optional[StrictStr] = Field(default=None, description="Teams channel or user")
    phone: Optional[StrictStr] = Field(default=None, description="Phone number in E.164 format")
    webhook_url: Optional[StrictStr] = Field(default=None, description="Webhook URL for webhook channel", alias="webhookURL")
    __properties: ClassVar[List[str]] = ["email", "slack", "teams", "phone", "webhookURL"]
