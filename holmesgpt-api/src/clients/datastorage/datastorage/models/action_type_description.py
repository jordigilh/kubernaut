...
class ActionTypeDescription(BaseModel):
    ...
    """ # noqa: E501
    what: StrictStr = Field(description="What this action type concretely does")
    when_to_use: StrictStr = Field(description="When this action type is appropriate", alias="whenToUse")
    when_not_to_use: Optional[StrictStr] = Field(default=None, description="Exclusion conditions", alias="whenNotToUse")
    preconditions: Optional[StrictStr] = Field(default=None, description="Conditions to verify before use")
