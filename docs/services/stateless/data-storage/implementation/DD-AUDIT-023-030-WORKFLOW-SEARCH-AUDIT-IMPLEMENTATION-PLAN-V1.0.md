...
|---------|------|---------|--------|
| **v1.1** | 2025-11-27 | **CRITICAL**: Updated to align with DD-WORKFLOW-004 v2.0. V1.0 scoring = confidence only (base similarity). Removed boost/penalty breakdown (deferred to V2.0+). Updated BR-AUDIT-026 and test examples. | ✅ **CURRENT** |
