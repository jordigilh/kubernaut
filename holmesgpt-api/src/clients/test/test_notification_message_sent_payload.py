...
class TestNotificationMessageSentPayload(unittest.TestCase):
    """NotificationMessageSentPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationMessageSentPayload:
        """Test NotificationMessageSentPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationMessageSentPayload`
        """
        model = NotificationMessageSentPayload()
        if include_optional:
            return NotificationMessageSentPayload(
                notification_id = '',
                channel = '',
                subject = '',
                body = '',
    ...
    def testNotificationMessageSentPayload(self):
        """Test NotificationMessageSentPayload"""
