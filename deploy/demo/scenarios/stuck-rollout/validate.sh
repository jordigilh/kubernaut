...
#   ./deploy/demo/scenarios/stuck-rollout/validate.sh [--auto-approve] [--no-color]
set -euo pipefail
...
wait_for_alert "KubeDeploymentRolloutStuck" "${NAMESPACE}" 300
show_alert "KubeDeploymentRolloutStuck"
