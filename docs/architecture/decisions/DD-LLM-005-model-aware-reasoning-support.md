...
- **Real OpenAI/Azure o-series and GPT-5 models (including GPT-5.6+ variants)**: passed through verbatim as Chat Completions' `reasoning_effort` field (`pkg/shared/llm/openaicompat`'s `EffortDialectOpenAI`).
