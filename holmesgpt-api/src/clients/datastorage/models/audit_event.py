...
class AuditEvent(BaseModel):
    ...
    def event_category_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gateway', 'notification', 'analysis', 'signalprocessing', 'workflow', 'execution', 'orchestration', 'webhook']):
    ...
    def event_outcome_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['success', 'failure', 'pending']):
