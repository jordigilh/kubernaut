...
class TestRemediationApprovalAuditPayload(unittest.TestCase):
    """RemediationApprovalAuditPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationApprovalAuditPayload:
        """Test RemediationApprovalAuditPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationApprovalAuditPayload`
        """
    ...
    def testRemediationApprovalAuditPayload(self):
        """Test RemediationApprovalAuditPayload"""
