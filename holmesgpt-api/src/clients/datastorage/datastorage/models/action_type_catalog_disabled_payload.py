...
class ActionTypeCatalogDisabledPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["event_type", "action_type", "disabled_by", "disabled_at"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('datastorage.actiontype.disabled'):
            raise ValueError("must be one of enum values ('datastorage.actiontype.disabled')")
        return value
