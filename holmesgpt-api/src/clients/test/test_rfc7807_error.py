...
class TestRFC7807Error(unittest.TestCase):
    """RFC7807Error unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RFC7807Error:
        """Test RFC7807Error
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RFC7807Error`
        """
        model = RFC7807Error()
        if include_optional:
            return RFC7807Error(
