...
class TestIncidentTypeBreakdownItem(unittest.TestCase):
    """IncidentTypeBreakdownItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentTypeBreakdownItem:
        """Test IncidentTypeBreakdownItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentTypeBreakdownItem`
        """
        model = IncidentTypeBreakdownItem()
        if include_optional:
            return IncidentTypeBreakdownItem(
    ...
    def testIncidentTypeBreakdownItem(self):
        """Test IncidentTypeBreakdownItem"""
