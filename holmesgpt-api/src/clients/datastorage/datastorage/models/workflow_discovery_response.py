...
class WorkflowDiscoveryResponse(BaseModel):
    ...
    """ # noqa: E501
    action_type: StrictStr = Field(description="The action type these workflows belong to", alias="actionType")
    workflows: List[WorkflowDiscoveryEntry]
    pagination: PaginationMetadata
    __properties: ClassVar[List[str]] = ["actionType", "workflows", "pagination"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "workflows": [WorkflowDiscoveryEntry.from_dict(_item) for _item in obj.get("workflows")] if obj.get("workflows") is not None else None,
            "pagination": PaginationMetadata.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None
        })
        return _obj
