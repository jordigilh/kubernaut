...
class ProviderResponseSummary(BaseModel):
    ...
    """ # noqa: E501
    incident_id: StrictStr = Field(description="Incident identifier")
    analysis_preview: StrictStr = Field(description="First 500 chars of analysis")
    selected_workflow_id: Optional[StrictStr] = Field(default=None, description="Selected workflow identifier (if any)")
    needs_human_review: StrictBool = Field(description="Whether human review is required")
    warnings_count: StrictInt = Field(description="Number of warnings from Holmes")
    __properties: ClassVar[List[str]] = ["incident_id", "analysis_preview", "selected_workflow_id", "needs_human_review", "warnings_count"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "analysis_preview": obj.get("analysis_preview"),
            "selected_workflow_id": obj.get("selected_workflow_id"),
