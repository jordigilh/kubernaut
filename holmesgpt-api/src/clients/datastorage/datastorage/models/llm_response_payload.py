...
class LLMResponsePayload(BaseModel):
    ...
    analysis_length: Annotated[int, Field(strict=True, ge=0)] = Field(description="Length of LLM response")
    ...
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('aiagent.llm.response'):
            raise ValueError("must be one of enum values ('aiagent.llm.response')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "analysis_length": obj.get("analysis_length"),
            "analysis_preview": obj.get("analysis_preview"),
            "tokens_used": obj.get("tokens_used"),
            "tool_call_count": obj.get("tool_call_count") if obj.get("tool_call_count") is not None else 0
        })
        return _obj
